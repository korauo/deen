...
module.exports = {
  ...
  async messageRun(message, args) {
    ...
    try {
      ...
      console.error("Error fetching Surah meanings:", error);
      await message.reply(
        "Failed to fetch Surah meanings. Please try again later.",
      );
    }
  },
  ...
  async interactionRun(interaction) {
    ...
    try {
      ...
      await interaction.followUp({
        content: "Failed to fetch Surah meanings. Please try again later.",
        ephemeral: true,
      });
    }
  },
